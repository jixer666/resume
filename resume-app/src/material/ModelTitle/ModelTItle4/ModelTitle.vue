<template>
  <div class="model-title-box u-tag-div">
    <div class="title-box u-tag-div">
      <h1 class="u-tag-h1">
        {{ title }}
      </h1>
    </div>
    <!-- 两个平行四边形 -->
    <div class="lozenge-1 u-tag-div" />
    <div class="lozenge-2 u-tag-div" />
  </div>
</template>
...
<style lang="scss" scoped>
  ...
  .title-box {
    ...
    background: linear-gradient(225deg, transparent 22px, v-bind('modelStyle.themeColor') 0) top right;
    .u-tag-h1 {
